        ...
        for (int loop = 0; loop < 2; loop++) {
            ...
            for (int i = 0; i < currentMelody.length; i++) {
                ...
                */
                ...
                // channels[0].controlChange(64, 127); // Sustain pedal down for melody channel (0) - REMOVED
                ...
                // channels[0].controlChange(64, 0); // Sustain pedal up for melody channel (0) - REMOVED
